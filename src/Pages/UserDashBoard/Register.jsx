...
const Register = () => {
  ...
  const handelRegister = (e) => {
    ...
    formData.append("phonNumber", phon);
    ...
    createUser(email, password)
      .then((result) => {
        ...
        updateProfile(creatUser, { displayName: name })
          .then(() => "display name set succesfully")
          .catch((error) => error);
          ...
          <div className="form-control mt-6">
            <label className="label">
              <span className="label-text-alt text-black">
                ...
                <Link to="/login">
                  <span className="link link-hover text-yellow-400">Login</span>
                </Link>
              </span>
            </label>
          </div>
